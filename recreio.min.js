...
!function(){function e(e){this.template=e.template,this.pattern=e.pattern,this.instruction=e.instruction,this.curriculum=e.curriculum;var t={},r=new Array,s=0;this.handleMouseMove=function(e){var n,r,o;e=e||window.event,null==e.pageX&&null!=e.clientX&&(n=e.target&&e.target.ownerDocument||document,r=n.documentElement,o=n.body,e.pageX=e.clientX+(r&&r.scrollLeft||o&&o.scrollLeft||0)-(r&&r.clientLeft||o&&o.clientLeft||0),e.pageY=e.clientY+(r&&r.scrollTop||o&&o.scrollTop||0)-(r&&r.clientTop||o&&o.clientTop||0)),t={x:e.pageX,y:e.pageY}},this.getMousePosition=function(){t.x&&t.y&&(r[s]={x:t.x,y:t.y},s++)},this.begin=function(){return user||console.error("Not yet authenticated."),this.startTime=(new Date).getTime(),document.onmousemove=this.handleMouseMove,this.mouseInterval=setInterval(this.getMousePosition,1e3/o),n.getAccount().then(function(e){user=e})["catch"](function(e){user={id:42,name:"John Doe"}}),this},this.save=function(t){if(!this.startTime)return console.error("Exercise hasn't started yet."),!1;this.endTime=(new Date).getTime(),this.duration=this.endTime-this.startTime,clearInterval(this.mouseInterval);var n={actor:{name:user.name,account:{id:user.id}},verb:{id:"completed"},object:{id:e.id,definition:{name:""}},result:{completion:!0,success:t,duration:Math.floor(Math.abs(this.duration/1e3))+"S"},context:{extensions:{app:i.appId,mouseMovement:r}},timestamp:i.getISODateString(new Date)};return i.request("POST","statements",n).then(function(e){})["catch"](function(e){console.error(e)}),n}}var t=require("bluebird");window.RecreIO=window.RecreIO||{};var n=window.RecreIO,r="https://api.recre.io/",o=10;n.globals=function(){var e=this;e.api_key="LWSQBugvzYB5xS9ZV8y6xrurGZmqCqDb",e.appId="1",this.request=function(n,o,i){return new t(function(t,s){var u=new XMLHttpRequest;u.open(n,r+o,!0),u.setRequestHeader("Content-Type","application/json;charset=UTF-8"),u.setRequestHeader("X-API-Key",e.api_key),u.withCredentials=!0,u.send(JSON.stringify(i)),u.onreadystatechange=function(){4===u.readyState&&(200===u.status?t(u.responseText):s(u.status))}})},this.getISODateString=function(e){function t(e,t){var n,r;for(("undefined"==typeof e||null===e)&&(e=0),("undefined"==typeof t||null===t)&&(t=2),n=Math.pow(10,t-1),r=e.toString();n>e&&n>1;)r="0"+r,n/=10;return r}return e.getUTCFullYear()+"-"+t(e.getUTCMonth()+1)+"-"+t(e.getUTCDate())+"T"+t(e.getUTCHours())+":"+t(e.getUTCMinutes())+":"+t(e.getUTCSeconds())+"."+t(e.getUTCMilliseconds(),3)+"Z"}};var i=new n.globals;n.getAccount=function(){return new t(function(e,t){i.request("GET","users/me").then(function(t){var n=JSON.parse(t);e(n)})["catch"](function(e){console.error(e),t(e)})})},n.signIn=function(e){return new t(function(e,t){i.request("GET","auth/providers").then(function(e){window.location.href=e})["catch"](function(e){console.error(e),t(e)})})},n.signInWithUsername=function(e,n){return new t(function(t,r){i.request("POST","auth/callback/password",{login:e,password:n,isUsername:!0}).then(function(e){t(JSON.parse(body))})["catch"](function(e){console.error(e),r(e)})})},n.signInWithEmail=function(e,n){return new t(function(t,r){i.request("POST","auth/callback/password",{login:e,password:n,isUsername:!1}).then(function(e){t(JSON.parse(body))})["catch"](function(e){console.error(e),r(e)})})};var s=[],u=0;n.getNextExercise=function(n){return"undefined"==typeof n&&(n="true-false"),new t(function(t,r){0==s.length||u==s.length-1?(u=0,i.request("GET","users/me/exercises?template="+n).then(function(n){s=JSON.parse(n),t(new e(s[0]))})["catch"](function(e){console.error(e),r(e)})):(u+=1,t(new e(s[u])))})},n.userStorage=function(){var e=new n.globals;n.getAccount().then(function(e){user=e})["catch"](function(e){user={id:42,name:"John Doe"}}),this.get=function(n){return new t(function(t,r){e.request("GET","users/"+user.id+"/storage/"+n).then(function(e){var o=JSON.parse(e);o[n]?t(o[n]):r("Unable to find a value for this key")})["catch"](function(e){console.error(e),r(e)})})},this.set=function(n,r){return new t(function(t,o){var i={};i[n]=r,e.request("PUT","users/"+user.id+"/storage/"+n,i).then(function(e){t(e)})["catch"](function(e){console.error(e),o(e)})})}},window.RecreIO.userStorage=new n.userStorage}();
...
//# sourceMappingURL=recreio.min.map.json