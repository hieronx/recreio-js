...
!function(){var e=require("bluebird");window.FortyTwo=window.FortyTwo||{};var n=window.FortyTwo;n.globals=function(){var n=this;n.url="http://api.42education.com/",n.version="v1",n.client_id="FaQg1U6Krm",n.client_secret="914acd359adc4dc968aa433cbc4ac6c5a3a48b7bade6b4512550a77df5fac651c4d0d272d2a08d03ce9088cb18265ba1",n.redirect_uri=null,n.db_name="db-42education",this.errorResponse=function(e,n,t){return{title:e,message:n,code:t}},this.request=function(t,r,o){return new e(function(e,i){var a=new XMLHttpRequest;a.open(t,n.url+n.version+"/"+r,!0),a.send(o),a.onreadystatechange=function(){4===a.readyState&&(200===a.status?e(a.responseText):i(a.status))}})},this.queryString=function(e){e=e.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var n=new RegExp("[\\?&]"+e+"=([^&#]*)"),t=n.exec(location.search);return null===t?"":decodeURIComponent(t[1].replace(/\+/g," "))}},n.User=function(){var e=new n.globals;this.register=function(n,t){e.request("PUT","register",n,t)}},n.Unit=function(){var t=new n.globals;this.all=function(){return new e(function(e,n){t.request("GET","units").then(function(n){var t=JSON.parse(n),r=[];for(key in t.rows){var o=t.rows[key];r.push(o.value)}e(r)})["catch"](function(e){n(e)})})}},n.Group=function(){},n.Statement=function(){},window.FortyTwo.User=new n.User,window.FortyTwo.Unit=new n.Unit,window.FortyTwo.Group=new n.Group,window.FortyTwo.Statement=new n.Statement}();
