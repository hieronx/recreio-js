...
!function(){function t(t){this.id=t.id,this.name=t.name,this.objects=[];for(var n in t.objects)this.objects.push(new e(t,t.objects[n]))}function e(t,e){this.unit=t,this.template=e.template,this.subtemplate=e.subtemplate,this.preInstruction=e.preInstruction,this.instruction=e.instruction,this.postInstruction=e.postInstruction,this.options=e.options,this.answer=e.answer,this.image=e.image,this.active=e.active,this.begin=function(){return this.user?(this.startTime=(new Date).getTime(),i.getAccount().then(function(t){this.user=t}),this):(console.error("Not yet authenticated."),!1)},this.save=function(t){if(!this.startTime)return console.error("Learning object hasn't started yet."),!1;this.endTime=(new Date).getTime(),this.duration=this.endTime-this.startTime;var e={actor:{name:this.user.name,account:{id:this.user.id}},verb:{id:"completed"},object:{id:this.unit.id,definition:{name:this.unit.name}},result:{completion:!0,success:t==this.answer,duration:Math.floor(Math.abs(this.duration/1e3))+"S"},context:{extensions:{app:s.appName}},timestamp:s.getISODateString(new Date)};return e}}var n=require("bluebird");window.FortyTwo=window.FortyTwo||{};var i=window.FortyTwo;i.globals=function(){var t=this;t.url="http://api.42education.com/",t.api_key="abcdef",t.appId="5bb424af3a8f20607ab384db88ea9ec0",t.appName="flashcards",this.request=function(e,i,s){return new n(function(n,o){var a=new XMLHttpRequest;a.open(e,t.url+i,!0),a.setRequestHeader("Content-Type","application/json;charset=UTF-8"),a.setRequestHeader("X-42-Key",t.api_key),a.withCredentials=!0,a.send(JSON.stringify(s)),a.onreadystatechange=function(){4===a.readyState&&(200===a.status?n(a.responseText):o(a.status))}})},this.getISODateString=function(t){function e(t,e){var n,i;for(("undefined"==typeof t||null===t)&&(t=0),("undefined"==typeof e||null===e)&&(e=2),n=Math.pow(10,e-1),i=t.toString();n>t&&n>1;)i="0"+i,n/=10;return i}return t.getUTCFullYear()+"-"+e(t.getUTCMonth()+1)+"-"+e(t.getUTCDate())+"T"+e(t.getUTCHours())+":"+e(t.getUTCMinutes())+":"+e(t.getUTCSeconds())+"."+e(t.getUTCMilliseconds(),3)+"Z"}};var s=new i.globals;i.getAccount=function(){return new n(function(t,e){s.request("GET","users/me").then(function(e){var n=JSON.parse(e);t(n)})["catch"](function(t){console.log(t),e(t)})})},i.signIn=function(){return new n(function(t,e){s.request("GET","auth/providers").then(function(t){window.location.href=t})["catch"](function(t){console.log(t),e(t)})})},i.getNextUnit=function(){return new n(function(e,n){var i={name:"unit",id:"c32d2b9351c318db70c87693b435edfa",inLanguage:"NL",typicalAgeRange:"10-12",objects:[{template:"multiple-choice",subtemplate:"choose-the-verb",preInstruction:"Choose the verb",answer:"talk",image:"https://assets.42education.com/home1.jpg",options:["boy","apple","talk","car"],active:!0}],alignments:[{name:"CCSS.ELA-Literacy.RST.11-12.3",url:"http://www.corestandards.org/ELA-Literacy/RST/11-12/3",description:"Follow precisely a complex multistep procedure when carrying out experiments, taking measurements, or performing technical tasks; analyze the specific results based on explanations in the text."}]};e(new t(i)),s.request("GET","units").then(function(n){e(new t(JSON.parse(n)))})["catch"](function(t){console.log(t),n(t)})})},i.getUnit=function(e){return new n(function(n,i){s.request("GET","units/"+e).then(function(e){n(new t(JSON.parse(e)))})["catch"](function(t){console.log(t),i(t)})})},i.userStorage=function(){var t=new i.globals;this.get=function(e){return new n(function(n,i){t.request("GET","settings/me/apps/"+t.appId).then(function(t){var s=JSON.parse(t);s[e]?n(s[e]):i("Unable to find a value for this key")})["catch"](function(t){console.log(t),i(t)})})},this.set=function(e,i){return new n(function(n,s){var o={};o[e]=i,t.request("PUT","settings/me/apps/"+t.appId,o).then(function(t){n(t)})["catch"](function(t){console.log(t),s(t)})})}},window.FortyTwo.userStorage=new i.userStorage}();
