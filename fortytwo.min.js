...
!function(){var e=require("bluebird");window.FortyTwo=window.FortyTwo||{};var t=window.FortyTwo;t.globals=function(){var e=this;e.url="http://api.42education.com/",e.version="v1",e.client_id="FaQg1U6Krm",e.client_secret="914acd359adc4dc968aa433cbc4ac6c5a3a48b7bade6b4512550a77df5fac651c4d0d272d2a08d03ce9088cb18265ba1",e.redirect_uri=null,e.db_name="db-42education",this.errorResponse=function(e,t,n){return{title:e,message:t,code:n}},this.request=function(t,n,r,o,i){var a=new XMLHttpRequest;a.open(t,e.url+e.version+"/"+n,!0),a.send(i),a.onreadystatechange=function(){4===a.readyState&&(200===a.status?r(a.responseText):o(e.errorResponse("",a.statusText,-1)))}},this.queryString=function(e){e=e.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var t=new RegExp("[\\?&]"+e+"=([^&#]*)"),n=t.exec(location.search);return null===n?"":decodeURIComponent(n[1].replace(/\+/g," "))}},t.User=function(){var e=new t.globals;this.register=function(t,n){e.request("PUT","register",t,n)}},t.Unit=function(){var n=new t.globals;this.all=function(){n.request("GET","units",function(t){var n=JSON.parse(t),r=[];for(key in n.rows){var o=n.rows[key];r.push(o.value)}return e.resolve(r)},function(t){return e.reject(t)})}},t.Group=function(){},t.Statement=function(){},window.FortyTwo.User=new t.User,window.FortyTwo.Unit=new t.Unit,window.FortyTwo.Group=new t.Group,window.FortyTwo.Statement=new t.Statement}();
