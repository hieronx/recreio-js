...
!function(){function e(e){this.id=e.id,this.name=e.name,this.template=e.template,this.pattern=e.pattern,this.active=e.active,this.curriculum=e.curriculum,this.inLanguage=e.inLanguage,this.typicalAgeRange=e.typicalAgeRange;var t={},o=new Array,s=0;this.handleMouseMove=function(e){var n,o,r;e=e||window.event,null==e.pageX&&null!=e.clientX&&(n=e.target&&e.target.ownerDocument||document,o=n.documentElement,r=n.body,e.pageX=e.clientX+(o&&o.scrollLeft||r&&r.scrollLeft||0)-(o&&o.clientLeft||r&&r.clientLeft||0),e.pageY=e.clientY+(o&&o.scrollTop||r&&r.scrollTop||0)-(o&&o.clientTop||r&&r.clientTop||0)),t={x:e.pageX,y:e.pageY}},this.getMousePosition=function(){t.x&&t.y&&(o[s]={x:t.x,y:t.y},s++)},this.begin=function(){return user||console.error("Not yet authenticated."),this.startTime=(new Date).getTime(),document.onmousemove=this.handleMouseMove,this.mouseInterval=setInterval(this.getMousePosition,1e3/r),n.getAccount().then(function(e){user=e})["catch"](function(){user={id:42,name:"John Doe"}}),this},this.save=function(t){if(!this.startTime)return console.error("Exercise hasn't started yet."),!1;this.endTime=(new Date).getTime(),this.duration=this.endTime-this.startTime,clearInterval(this.mouseInterval);var n={actor:{name:user.name,account:{id:user.id}},verb:{id:"completed"},object:{id:e.id,definition:{name:e.name}},result:{completion:!0,success:t==this.answer,duration:Math.floor(Math.abs(this.duration/1e3))+"S"},context:{extensions:{app:i.appName,mouseMovement:o}},timestamp:i.getISODateString(new Date)};return i.request("POST","statements",n).then(function(){})["catch"](function(e){console.error(e)}),n}}var t=require("bluebird");window.FortyTwo=window.FortyTwo||{};var n=window.FortyTwo,o="http://api.42education.com/",r=10;n.globals=function(){var e=this;e.api_key="abcdef",e.appId="5bb424af3a8f20607ab384db88ea9ec0",e.appName="flashcards",this.request=function(e,n,r){return new t(function(t,i){var s=new XMLHttpRequest;s.open(e,o+n,!0),s.setRequestHeader("Content-Type","application/json;charset=UTF-8"),s.withCredentials=!0,s.send(JSON.stringify(r)),s.onreadystatechange=function(){4===s.readyState&&(200===s.status?t(s.responseText):i(s.status))}})},this.getISODateString=function(e){function t(e,t){var n,o;for(("undefined"==typeof e||null===e)&&(e=0),("undefined"==typeof t||null===t)&&(t=2),n=Math.pow(10,t-1),o=e.toString();n>e&&n>1;)o="0"+o,n/=10;return o}return e.getUTCFullYear()+"-"+t(e.getUTCMonth()+1)+"-"+t(e.getUTCDate())+"T"+t(e.getUTCHours())+":"+t(e.getUTCMinutes())+":"+t(e.getUTCSeconds())+"."+t(e.getUTCMilliseconds(),3)+"Z"}};var i=new n.globals;n.getAccount=function(){return new t(function(e,t){i.request("GET","users/me").then(function(t){var n=JSON.parse(t);e(n)})["catch"](function(e){console.error(e),t(e)})})},n.signIn=function(){return new t(function(e,t){i.request("GET","auth/providers").then(function(e){window.location.href=e})["catch"](function(e){console.error(e),t(e)})})},n.signInWithPassword=function(e,n){return new t(function(t,o){i.request("POST","auth/callback/password",{login:e,password:n,isUsername:!0}).then(function(){t(JSON.parse(body))})["catch"](function(e){console.error(e),o(e)})})},n.signInWithEmail=function(e,n){return new t(function(t,o){i.request("POST","auth/callback/password",{login:e,password:n,isUsername:!1}).then(function(){t(JSON.parse(body))})["catch"](function(e){console.error(e),o(e)})})},n.getNextExercise=function(){return new t(function(t,n){i.request("GET","users/me/assignments?status=open").then(function(o){if(0==JSON.parse(o).length)i.request("GET","exercises").then(function(n){t(new e(JSON.parse(n)[0]))})["catch"](function(e){console.error(e),n(e)});else{var r=JSON.parse(o);i.request("GET","exercises/"+r[0].exerciseId).then(function(n){t(new e(JSON.parse(n)))})["catch"](function(e){console.error(e),n(e)})}})["catch"](function(e){console.error(e),n(e)})})},n.getExercise=function(n){return new t(function(t,o){i.request("GET","exercises/"+n).then(function(n){t(new e(JSON.parse(n)))})["catch"](function(e){console.error(e),o(e)})})},n.userStorage=function(){var e=new n.globals;n.getAccount().then(function(e){user=e})["catch"](function(){user={id:42,name:"John Doe"}}),this.get=function(n){return new t(function(t,o){e.request("GET","users/"+user.id+"/storage/"+n).then(function(e){var r=JSON.parse(e);r[n]?t(r[n]):o("Unable to find a value for this key")})["catch"](function(e){console.error(e),o(e)})})},this.set=function(n,o){return new t(function(t,r){var i={};i[n]=o,e.request("PUT","users/"+user.id+"/storage/"+n,i).then(function(e){t(e)})["catch"](function(e){console.error(e),r(e)})})}},window.FortyTwo.userStorage=new n.userStorage}();
...
//# sourceMappingURL=fortytwo.min.map.json