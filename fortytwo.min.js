...
!function(){function n(n){this.name=n.name,this.objects=n.objects}function t(){this.length=0,this.first=null}var e=require("bluebird");window.FortyTwo=window.FortyTwo||{};var o=window.FortyTwo;o.globals=function(){var n=this;n.url="http://api.42education.com/",n.api_key="abcdef",n.appId="5bb424af3a8f20607ab384db88ea9ec0",this.request=function(t,o,i){return new e(function(e,s){var r=new XMLHttpRequest;r.open(t,n.url+o,!0),r.setRequestHeader("Content-Type","application/json;charset=UTF-8"),r.setRequestHeader("X-42-Key",n.api_key),r.withCredentials=!0,r.send(JSON.stringify(i)),r.onreadystatechange=function(){4===r.readyState&&(200===r.status?e(r.responseText):s(r.status))}})}};var i=new o.globals;o.getAccount=function(){return new e(function(n,t){i.request("GET","users/me").then(function(t){var e=JSON.parse(t);n(e)})["catch"](function(n){console.log(n),t(n)})})},o.signIn=function(){return new e(function(n,t){i.request("GET","auth/providers").then(function(n){window.location.href=n})["catch"](function(n){console.log(n),t(n)})})},o.getNextUnit=function(){return new e(function(t,e){i.request("GET","units").then(function(e){var o=JSON.parse(e);t(new n(o[0]))})["catch"](function(n){console.log(n),e(n)})})},t.prototype={add:function(n){var t,e={data:n,next:null};if(null===this.first)this.first=e;else{for(t=this.first;t.next;)t=t.next;t.next=e}this.length++}},o.getUnit=function(t){return new e(function(e,o){i.request("GET","units/"+t).then(function(t){e(new n(JSON.parse(t)))})["catch"](function(n){console.log(n),o(n)})})},o.userStorage=function(){var n=new o.globals;this.get=function(t){return new e(function(e,o){n.request("GET","settings/me/apps/"+n.appId).then(function(n){var i=JSON.parse(n);i[t]?e(i[t]):o("Unable to find a value for this key")})["catch"](function(n){console.log(n),o(n)})})},this.set=function(t,o){return new e(function(e,i){var s={};s[t]=o,n.request("PUT","settings/me/apps/"+n.appId,s).then(function(n){e(n)})["catch"](function(n){console.log(n),i(n)})})}},window.FortyTwo.userStorage=new o.userStorage}();
