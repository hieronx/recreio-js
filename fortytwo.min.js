...
!function(){var n=require("bluebird");window.FortyTwo=window.FortyTwo||{};var e=window.FortyTwo;e.globals=function(){var e=this;e.url="http://api.42education.com/",e.version="v1",e.client_id="FaQg1U6Krm",e.client_secret="914acd359adc4dc968aa433cbc4ac6c5a3a48b7bade6b4512550a77df5fac651c4d0d272d2a08d03ce9088cb18265ba1",e.redirect_uri=null,e.db_name="db-42education",this.errorResponse=function(n,e,t){return{title:n,message:e,code:t}},this.request=function(t,o,r){return new n(function(n,i){var c=new XMLHttpRequest;c.open(t,e.url+e.version+"/"+o,!0),c.send(r),c.onreadystatechange=function(){4===c.readyState&&(200===c.status?n(c.responseText):i(c.status))}})},this.queryString=function(n){n=n.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var e=new RegExp("[\\?&]"+n+"=([^&#]*)"),t=e.exec(location.search);return null===t?"":decodeURIComponent(t[1].replace(/\+/g," "))}},e.User=function(){var n=new e.globals;this.register=function(e,t){n.request("PUT","register",e,t)}},e.Unit=function(){var t=new e.globals;this.all=function(){return new n(function(n,e){t.request("GET","units").then(function(e){var t=JSON.parse(e);console.log(t),n(t.rows)})["catch"](function(n){console.log(n),e(n)})})},this.find=function(e){return new n(function(n,o){t.request("GET","units/"+e).then(function(e){var t=JSON.parse(e);console.log(t),n(t.rows)})["catch"](function(n){console.log(n),o(n)})})},this.find=function(e,o){return new n(function(n,r){t.request("PUT","units/"+e,o).then(function(e){var t=JSON.parse(e);console.log(t),n(t.rows)})["catch"](function(n){console.log(n),r(n)})})}},e.Group=function(){},e.Statement=function(){},window.FortyTwo.User=new e.User,window.FortyTwo.Unit=new e.Unit,window.FortyTwo.Group=new e.Group,window.FortyTwo.Statement=new e.Statement}();
