...
!function(){var n=require("bluebird");window.FortyTwo=window.FortyTwo||{};var t=window.FortyTwo;t.globals=function(){var t=this;t.url="http://api.42education.com/",t.version="v1",t.client_id="FaQg1U6Krm",t.client_secret="914acd359adc4dc968aa433cbc4ac6c5a3a48b7bade6b4512550a77df5fac651c4d0d272d2a08d03ce9088cb18265ba1",t.redirect_uri=null,t.db_name="db-42education",this.errorResponse=function(n,t,e){return{title:n,message:t,code:e}},this.request=function(e,o,r){return new n(function(n,i){var c=new XMLHttpRequest;c.open(e,t.url+t.version+"/"+o,!0),c.setRequestHeader("Content-Type","application/json;charset=UTF-8"),c.send(JSON.stringify(r)),c.onreadystatechange=function(){4===c.readyState&&(200===c.status?n(c.responseText):i(c.status))}})},this.queryString=function(n){n=n.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var t=new RegExp("[\\?&]"+n+"=([^&#]*)"),e=t.exec(location.search);return null===e?"":decodeURIComponent(e[1].replace(/\+/g," "))}},t.User=function(){var n=new t.globals;this.register=function(t,e){n.request("PUT","register",t,e)}},t.Unit=function(){var e=new t.globals;this.all=function(){return new n(function(n,t){e.request("GET","units").then(function(t){var e=JSON.parse(t);n(e)})["catch"](function(n){console.log(n),t(n)})})},this.find=function(t){return new n(function(n,o){e.request("GET","units/"+t).then(function(t){var e=JSON.parse(t);n(e)})["catch"](function(n){console.log(n),o(n)})})},this.add=function(t){return new n(function(n,o){e.request("POST","units",t).then(function(t){var e=JSON.parse(t);n(e)})["catch"](function(n){console.log(n),o(n)})})},this.update=function(t,o){return new n(function(n,r){e.request("PUT","units/"+t,o).then(function(t){var e=JSON.parse(t);n(e)})["catch"](function(n){console.log(n),r(n)})})},this.remove=function(t){return new n(function(n,o){e.request("DELETE","units/"+t).then(function(t){var e=JSON.parse(t);n(e)})["catch"](function(n){console.log(n),o(n)})})}},t.Group=function(){},t.Statement=function(){},window.FortyTwo.User=new t.User,window.FortyTwo.Unit=new t.Unit,window.FortyTwo.Group=new t.Group,window.FortyTwo.Statement=new t.Statement}();
