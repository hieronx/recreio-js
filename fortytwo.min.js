...
!function(){var n=require("bluebird");window.FortyTwo=window.FortyTwo||{};var e=window.FortyTwo;e.globals=function(){var e=this;e.url="http://api.42education.com/",e.api_key="abcdef",this.errorResponse=function(n,e,t){return{title:n,message:e,code:t}},this.request=function(t,o,c){return new n(function(n,r){var i=new XMLHttpRequest;i.open(t,e.url+o,!0),i.setRequestHeader("Content-Type","application/json;charset=UTF-8"),i.withCredentials=!0,i.send(JSON.stringify(c)),i.onreadystatechange=function(){4===i.readyState&&(200===i.status?n(i.responseText):r(i.status))}})},this.queryString=function(n){n=n.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var e=new RegExp("[\\?&]"+n+"=([^&#]*)"),t=e.exec(location.search);return null===t?"":decodeURIComponent(t[1].replace(/\+/g," "))}};var t=new e.globals;e.getAccount=function(){return new n(function(n,e){t.request("GET","users/me").then(function(e){var t=JSON.parse(e);n(t)})["catch"](function(n){console.log(n),e(n)})})},e.signIn=function(){return new n(function(n,e){t.request("GET","auth/providers").then(function(n){window.location.href=n})["catch"](function(n){console.log(n),e(n)})})},e.getNextUnit=function(){return new n(function(n,e){t.request("GET","units").then(function(e){var t=JSON.parse(e);n(t[0])})["catch"](function(n){console.log(n),e(n)})})},e.getAssignedUnits=function(){return new n(function(n,e){t.request("GET","/users/me/assignments?status=open").then(function(e){var t=JSON.parse(e);n(t)})["catch"](function(n){console.log(n),e(n)})})},e.findUnit=function(e){return new n(function(n,o){t.request("GET","units/"+e).then(function(e){n(JSON.parse(e))})["catch"](function(n){console.log(n),o(n)})})},e.get=function(e){return new n(function(n,o){t.request("GET","settings/me/apps/5bb424af3a8f20607ab384db88ea9ec0").then(function(t){var c=JSON.parse(t);c[e]?n(c[e]):o("Unable to find a value for this key")})["catch"](function(n){console.log(n),o(n)})})},e.set=function(e,o){return new n(function(n,c){var r={};r[e]=o,t.request("PUT","settings/me/apps/5bb424af3a8f20607ab384db88ea9ec0",r).then(function(e){n(e)})["catch"](function(n){console.log(n),c(n)})})}}();
