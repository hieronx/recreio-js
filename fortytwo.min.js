...
!function(){function e(e){this.id=e.id,this.name=e.name,this.objects=[];for(var n in e.objects)this.objects.push(new t(e,e.objects[n]))}function t(e,t){var n={},i=e;this.template=t.template,this.subtemplate=t.subtemplate,this.preInstruction=t.preInstruction,this.instruction=t.instruction,this.postInstruction=t.postInstruction,this.options=t.options,this.answer=t.answer,this.image=t.image,this.active=t.active;var r={},c=new Array,u=0;this.handleMouseMove=function(e){var t,n,o;e=e||window.event,null==e.pageX&&null!=e.clientX&&(t=e.target&&e.target.ownerDocument||document,n=t.documentElement,o=t.body,e.pageX=e.clientX+(n&&n.scrollLeft||o&&o.scrollLeft||0)-(n&&n.clientLeft||o&&o.clientLeft||0),e.pageY=e.clientY+(n&&n.scrollTop||o&&o.scrollTop||0)-(n&&n.clientTop||o&&o.clientTop||0)),r={x:e.pageX,y:e.pageY}},this.getMousePosition=function(){r.x&&r.y&&(c[u]={x:r.x,y:r.y},u++)},this.begin=function(){return n||console.error("Not yet authenticated."),this.startTime=(new Date).getTime(),document.onmousemove=this.handleMouseMove,this.mouseInterval=setInterval(this.getMousePosition,1e3/s),o.getAccount().then(function(e){n=e}).error(function(){n={id:42,name:"John Doe"}}),this},this.save=function(e){if(!this.startTime)return console.error("Learning object hasn't started yet."),!1;this.endTime=(new Date).getTime(),this.duration=this.endTime-this.startTime,clearInterval(this.mouseInterval);var t={actor:{name:n.name,account:{id:n.id}},verb:{id:"completed"},object:{id:i.id,definition:{name:i.name}},result:{completion:!0,success:e==this.answer,duration:Math.floor(Math.abs(this.duration/1e3))+"S"},context:{extensions:{app:a.appName,mouseMovement:c}},timestamp:a.getISODateString(new Date)};return t}}var n=require("bluebird");window.FortyTwo=window.FortyTwo||{};var o=window.FortyTwo,i="http://api.42education.com/",s=10;o.globals=function(){var e=this;e.api_key="abcdef",e.appId="5bb424af3a8f20607ab384db88ea9ec0",e.appName="flashcards",this.request=function(t,o,s){return new n(function(n,a){var r=new XMLHttpRequest;r.open(t,i+o,!0),r.setRequestHeader("Content-Type","application/json;charset=UTF-8"),r.setRequestHeader("X-42-Key",e.api_key),r.withCredentials=!0,r.send(JSON.stringify(s)),r.onreadystatechange=function(){4===r.readyState&&(200===r.status?n(r.responseText):a(r.status))}})},this.getISODateString=function(e){function t(e,t){var n,o;for(("undefined"==typeof e||null===e)&&(e=0),("undefined"==typeof t||null===t)&&(t=2),n=Math.pow(10,t-1),o=e.toString();n>e&&n>1;)o="0"+o,n/=10;return o}return e.getUTCFullYear()+"-"+t(e.getUTCMonth()+1)+"-"+t(e.getUTCDate())+"T"+t(e.getUTCHours())+":"+t(e.getUTCMinutes())+":"+t(e.getUTCSeconds())+"."+t(e.getUTCMilliseconds(),3)+"Z"}};var a=new o.globals;o.getAccount=function(){return new n(function(e,t){a.request("GET","users/me").then(function(t){var n=JSON.parse(t);e(n)})["catch"](function(e){console.log(e),t(e)})})},o.signIn=function(){return new n(function(e,t){a.request("GET","auth/providers").then(function(e){window.location.href=e})["catch"](function(e){console.log(e),t(e)})})},o.getNextUnit=function(){return new n(function(t,n){var o={name:"unit",id:"c32d2b9351c318db70c87693b435edfa",inLanguage:"NL",typicalAgeRange:"10-12",objects:[{template:"multiple-choice",subtemplate:"choose-the-verb",preInstruction:"Choose the verb",answer:"talk",image:"https://assets.42education.com/home1.jpg",options:["boy","apple","talk","car"],active:!0}],alignments:[{name:"CCSS.ELA-Literacy.RST.11-12.3",url:"http://www.corestandards.org/ELA-Literacy/RST/11-12/3",description:"Follow precisely a complex multistep procedure when carrying out experiments, taking measurements, or performing technical tasks; analyze the specific results based on explanations in the text."}]};t(new e(o)),a.request("GET","units").then(function(n){t(new e(JSON.parse(n)))})["catch"](function(e){console.log(e),n(e)})})},o.getUnit=function(t){return new n(function(n,o){a.request("GET","units/"+t).then(function(t){n(new e(JSON.parse(t)))})["catch"](function(e){console.log(e),o(e)})})},o.userStorage=function(){var e=new o.globals;this.get=function(t){return new n(function(n,o){e.request("GET","settings/me/apps/"+e.appId).then(function(e){var i=JSON.parse(e);i[t]?n(i[t]):o("Unable to find a value for this key")})["catch"](function(e){console.log(e),o(e)})})},this.set=function(t,o){return new n(function(n,i){var s={};s[t]=o,e.request("PUT","settings/me/apps/"+e.appId,s).then(function(e){n(e)})["catch"](function(e){console.log(e),i(e)})})}},window.FortyTwo.userStorage=new o.userStorage}();
