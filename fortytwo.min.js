...
!function(){function t(t){this.name=t.name,this.objects=[];for(var n in t.objects)this.objects.push(new e(t.objects[n]));this.begin=function(){this.startTime=(new Date).getTime()},this.end=function(){this.endTime=(new Date).getTime(),this.duration=this.endTime-this.startTime,console.log(this.name+" took you "+this.duration+"s")}}function e(t){this.template=t.template,this.subtemplate=t.subtemplate,this.preInstruction=t.preInstruction,this.instruction=t.instruction,this.postInstruction=t.postInstruction,this.options=t.options,this.answer=t.answer,this.image=t.image,this.active=t.active,this.save=function(t){console.log(t==this.answer?"That's right!":"Hmm, that's wrong..")}}var n=require("bluebird");window.FortyTwo=window.FortyTwo||{};var i=window.FortyTwo;i.globals=function(){var t=this;t.url="http://api.42education.com/",t.api_key="abcdef",t.appId="5bb424af3a8f20607ab384db88ea9ec0",this.request=function(e,i,o){return new n(function(n,s){var a=new XMLHttpRequest;a.open(e,t.url+i,!0),a.setRequestHeader("Content-Type","application/json;charset=UTF-8"),a.setRequestHeader("X-42-Key",t.api_key),a.withCredentials=!0,a.send(JSON.stringify(o)),a.onreadystatechange=function(){4===a.readyState&&(200===a.status?n(a.responseText):s(a.status))}})}};var o=new i.globals;i.getAccount=function(){return new n(function(t,e){o.request("GET","users/me").then(function(e){var n=JSON.parse(e);t(n)})["catch"](function(t){console.log(t),e(t)})})},i.signIn=function(){return new n(function(t,e){o.request("GET","auth/providers").then(function(t){window.location.href=t})["catch"](function(t){console.log(t),e(t)})})},i.getNextUnit=function(){return new n(function(e,n){var i={name:"unit",id:"c32d2b9351c318db70c87693b435edfa",inLanguage:"NL",typicalAgeRange:"10-12",objects:[{template:"multiple-choice",subtemplate:"choose-the-verb",preInstruction:"Choose the verb",answer:"talk",image:"https://assets.42education.com/home1.jpg",options:["boy","apple","talk","car"],active:!0}],alignments:[{name:"CCSS.ELA-Literacy.RST.11-12.3",url:"http://www.corestandards.org/ELA-Literacy/RST/11-12/3",description:"Follow precisely a complex multistep procedure when carrying out experiments, taking measurements, or performing technical tasks; analyze the specific results based on explanations in the text."}]};e(new t(i)),o.request("GET","units").then(function(n){e(new t(JSON.parse(n)))})["catch"](function(t){console.log(t),n(t)})})},i.getUnit=function(e){return new n(function(n,i){o.request("GET","units/"+e).then(function(e){n(new t(JSON.parse(e)))})["catch"](function(t){console.log(t),i(t)})})},i.userStorage=function(){var t=new i.globals;this.get=function(e){return new n(function(n,i){t.request("GET","settings/me/apps/"+t.appId).then(function(t){var o=JSON.parse(t);o[e]?n(o[e]):i("Unable to find a value for this key")})["catch"](function(t){console.log(t),i(t)})})},this.set=function(e,i){return new n(function(n,o){var s={};s[e]=i,t.request("PUT","settings/me/apps/"+t.appId,s).then(function(t){n(t)})["catch"](function(t){console.log(t),o(t)})})}},window.FortyTwo.userStorage=new i.userStorage}();
