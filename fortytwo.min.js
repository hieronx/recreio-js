...
!function(){var n=require("bluebird");window.FortyTwo=window.FortyTwo||{};var t=window.FortyTwo;t.globals=function(){var t=this;t.url="http://api.42education.com/",t.api_key="abcdef",t.appId="5bb424af3a8f20607ab384db88ea9ec0",this.request=function(e,o,u){return new n(function(n,i){var s=new XMLHttpRequest;s.open(e,t.url+o,!0),s.setRequestHeader("Content-Type","application/json;charset=UTF-8"),s.setRequestHeader("X-42-Key",t.api_key),s.withCredentials=!0,s.send(JSON.stringify(u)),s.onreadystatechange=function(){4===s.readyState&&(200===s.status?n(s.responseText):i(s.status))}})}};var e=new t.globals;t.getAccount=function(){return new n(function(n,t){e.request("GET","users/me").then(function(t){var e=JSON.parse(t);n(e)})["catch"](function(n){console.log(n),t(n)})})},t.signIn=function(){return new n(function(n,t){e.request("GET","auth/providers").then(function(n){window.location.href=n})["catch"](function(n){console.log(n),t(n)})})},t.getNextUnit=function(){return new n(function(n,t){e.request("GET","units").then(function(t){var e=JSON.parse(t);n(e[0])})["catch"](function(n){console.log(n),t(n)})})},t.getAssignedUnits=function(){return new n(function(n,t){e.request("GET","users/me/assignments?status=open").then(function(t){var e=JSON.parse(t);n(e)})["catch"](function(n){console.log(n),t(n)})})},t.findUnit=function(t){return new n(function(n,o){e.request("GET","units/"+t).then(function(t){n(JSON.parse(t))})["catch"](function(n){console.log(n),o(n)})})},t.get=function(t){return new n(function(n,o){e.request("GET","settings/me/apps/"+e.appId).then(function(e){var u=JSON.parse(e);u[t]?n(u[t]):o("Unable to find a value for this key")})["catch"](function(n){console.log(n),o(n)})})},t.set=function(t,o){return new n(function(n,u){var i={};i[t]=o,e.request("PUT","settings/me/apps/"+e.appId,i).then(function(t){n(t)})["catch"](function(n){console.log(n),u(n)})})}}();
