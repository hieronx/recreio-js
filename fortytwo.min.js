...
!function(){function t(t){this.id=t.id,this.name=t.name,this.objects=[];for(var n in t.objects)this.objects.push(new e(t,t.objects[n]))}function e(t,e){var n={},i=t;this.template=e.template,this.subtemplate=e.subtemplate,this.preInstruction=e.preInstruction,this.instruction=e.instruction,this.postInstruction=e.postInstruction,this.options=e.options,this.answer=e.answer,this.image=e.image,this.active=e.active;var r={},c=new Array,u=0;this.handleMouseMove=function(t){var e,n,o;t=t||window.event,null==t.pageX&&null!=t.clientX&&(e=t.target&&t.target.ownerDocument||document,n=e.documentElement,o=e.body,t.pageX=t.clientX+(n&&n.scrollLeft||o&&o.scrollLeft||0)-(n&&n.clientLeft||o&&o.clientLeft||0),t.pageY=t.clientY+(n&&n.scrollTop||o&&o.scrollTop||0)-(n&&n.clientTop||o&&o.clientTop||0)),r={x:t.pageX,y:t.pageY}},this.getMousePosition=function(){r.x&&r.y&&(c[u]={x:r.x,y:r.y},u++)},this.begin=function(){return n||console.error("Not yet authenticated."),this.startTime=(new Date).getTime(),document.onmousemove=this.handleMouseMove,this.mouseInterval=setInterval(this.getMousePosition,1e3/s),o.getAccount().then(function(t){n=t})["catch"](function(){n={id:42,name:"John Doe"}}),this},this.save=function(t){if(!this.startTime)return console.error("Learning object hasn't started yet."),!1;this.endTime=(new Date).getTime(),this.duration=this.endTime-this.startTime,clearInterval(this.mouseInterval);var e={actor:{name:n.name,account:{id:n.id}},verb:{id:"completed"},object:{id:i.id,definition:{name:i.name}},result:{completion:!0,success:t==this.answer,duration:Math.floor(Math.abs(this.duration/1e3))+"S"},context:{extensions:{app:a.appName,mouseMovement:c}},timestamp:a.getISODateString(new Date)};return e}}var n=require("bluebird");window.FortyTwo=window.FortyTwo||{};var o=window.FortyTwo,i="http://api.42education.com/",s=10;o.globals=function(){var t=this;t.api_key="abcdef",t.appId="5bb424af3a8f20607ab384db88ea9ec0",t.appName="flashcards",this.request=function(e,o,s){return new n(function(n,a){var r=new XMLHttpRequest;r.open(e,i+o,!0),r.setRequestHeader("Content-Type","application/json;charset=UTF-8"),r.setRequestHeader("X-42-Key",t.api_key),r.withCredentials=!0,r.send(JSON.stringify(s)),r.onreadystatechange=function(){4===r.readyState&&(200===r.status?n(r.responseText):a(r.status))}})},this.getISODateString=function(t){function e(t,e){var n,o;for(("undefined"==typeof t||null===t)&&(t=0),("undefined"==typeof e||null===e)&&(e=2),n=Math.pow(10,e-1),o=t.toString();n>t&&n>1;)o="0"+o,n/=10;return o}return t.getUTCFullYear()+"-"+e(t.getUTCMonth()+1)+"-"+e(t.getUTCDate())+"T"+e(t.getUTCHours())+":"+e(t.getUTCMinutes())+":"+e(t.getUTCSeconds())+"."+e(t.getUTCMilliseconds(),3)+"Z"}};var a=new o.globals;o.getAccount=function(){return new n(function(t,e){a.request("GET","users/me").then(function(e){var n=JSON.parse(e);t(n)})["catch"](function(t){console.log(t),e(t)})})},o.signIn=function(){return new n(function(t,e){a.request("GET","auth/providers").then(function(t){window.location.href=t})["catch"](function(t){console.log(t),e(t)})})},o.getNextUnit=function(){return new n(function(e,n){var o={name:"unit",id:"c32d2b9351c318db70c87693b435edfa",inLanguage:"NL",typicalAgeRange:"10-12",objects:[{template:"multiple-choice",subtemplate:"choose-the-verb",preInstruction:"Choose the verb",answer:"talk",image:"https://assets.42education.com/home1.jpg",options:["boy","apple","talk","car"],active:!0}],alignments:[{name:"CCSS.ELA-Literacy.RST.11-12.3",url:"http://www.corestandards.org/ELA-Literacy/RST/11-12/3",description:"Follow precisely a complex multistep procedure when carrying out experiments, taking measurements, or performing technical tasks; analyze the specific results based on explanations in the text."}]};e(new t(o)),a.request("GET","units").then(function(n){e(new t(JSON.parse(n)))})["catch"](function(t){console.log(t),n(t)})})},o.getUnit=function(e){return new n(function(n,o){a.request("GET","units/"+e).then(function(e){n(new t(JSON.parse(e)))})["catch"](function(t){console.log(t),o(t)})})},o.userStorage=function(){var t=new o.globals;this.get=function(e){return new n(function(n,o){t.request("GET","settings/me/apps/"+t.appId).then(function(t){var i=JSON.parse(t);i[e]?n(i[e]):o("Unable to find a value for this key")})["catch"](function(t){console.log(t),o(t)})})},this.set=function(e,o){return new n(function(n,i){var s={};s[e]=o,t.request("PUT","settings/me/apps/"+t.appId,s).then(function(t){n(t)})["catch"](function(t){console.log(t),i(t)})})}},window.FortyTwo.userStorage=new o.userStorage}();
